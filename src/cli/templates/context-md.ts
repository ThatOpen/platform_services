...
export function getContextMdTest(): string {
  return `# ThatOpen Platform API Test Suite (App)
...
export function getContextMdCloudTest(): string {
  return `# ThatOpen Platform API Test Suite (Cloud Component)
