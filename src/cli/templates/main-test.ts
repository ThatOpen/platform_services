export function getMainTest(): string {
  const backtick = '`';
  const dollar = '$';
  ...
  return [
    ...
    '          ' + dollar + '{componentIdInput}',
    '          <bim-label>Local Server URL:</bim-label>',
    '          ' + dollar + '{localServerInput}',
    '        </bim-panel-section>',
    '        <bim-panel-section label="Controls">',
    '          <bim-button label="Run All Tests" icon="solar:play-bold"',
    '            @click=' + dollar + '{() => runAllTests(resultsContainer, client, componentIdInput, localServerInput)}></bim-button>',
    '        </bim-panel-section>',
    '        <bim-panel-section label="Results">',
    '          ' + dollar + '{resultsContainer}',
    '        </bim-panel-section>',
    '      </bim-panel>',
    '    ' + backtick + ';',
    '  };',
    ...
    '    layouts: {',
    '      Tests: {',
    '        template: ' + backtick + '"panel viewer" 1fr / 24rem 1fr' + backtick + ',',
